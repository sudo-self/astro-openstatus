...
import { A as AstroUserError, a as App } from './astro_PwN0r0dF.mjs';
import { r as reactExports, R as React } from './react_BatLIxD_.mjs';
import { s as server_browser } from './react-dom_BlIcpVJp.mjs';
import { w, R, k, j } from './ultrahtml_B2GJy-WT.mjs';
...
function createExports(manifest) {
  ...
  const fetch = async (request, env, context) => {
    ...
    await import(
      /* @vite-ignore */
      setupModule
    ).then((mod) => mod.setGetEnv(createGetEnv(env))).catch(() => {
    });
...
export { _renderer0 as _, createExports as c, serverEntrypointModule as s };
